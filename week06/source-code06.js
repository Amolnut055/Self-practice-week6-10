...
function updateQuote(id, updatedQuote) {
  const findID = quotes.findIndex(i => i.id === id)
  if(findID !== -1) {
    quotes[findID] = {...quotes[findID] , ...updateQuote}
  }
...
updateQuote({ id: 3, content: "It does not matter how slowly you go as long as you do not stop.", author: "Confucius" })
